...
/*.settings-active a:hover{background:#fff;border:1px solid #e5e5e5;border-bottom:0;color:#333;font-weight:bold;padding-top:3px;}*/
  ...
  <ul class="settings-tabs_ul"> 
    ...
    <li><a href="my-elooi-settings-sharing.php" id="">Sharing</a></li> 
    <li class="settings-active"><a href="my-elooi-settings-privacy.php" id="">Privacy</a></li> 
...
<li>Let others find me by my email address
<li>Let non friends send me messages
<li>Only my frineds can listen to my eloois
<li>Link to my Facebook profile from my public elooi profile 
