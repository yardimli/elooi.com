...
<script type="text/javascript">
  ...
  window.fbAsyncInit = function() {
    FB.init({ appId: CloudOfVoice_fbAppId, status: true, cookie: true, xfbml: true, oauth: true });
...
<script type="text/javascript">
	var CloudOfVoice_fbAppId = '146170835459093';
	var CloudOfVoice_fbPerms =	'email,offline_access,publish_stream,user_location,user_birthday,user_about_me,user_likes,user_status,user_website,user_interests,user_online_presence,user_hometown';
