<?php
	...
	$Submit_Button_Txt = "Send"; //

	$Footer_About = "Om oss"; //
	$Footer_Blog = "Blog"; //
	$Footer_Contact = "Kontakt"; //
	$Footer_Help = "Hjelp"; //
	$Footer_Developers = "Utviklere"; //
	$Footer_Privacy = "Personvern"; //
	$Footer_TOS = "Betingelser"; //
	$Footer_Location = "Sted"; //
	$Footer_No_Location = "Ikke vis sted"; //

	$Footer_Badges = "Merker"; //
	$Header_Badges = "Elooi Merker"; //
	$me_general_rep_points = "Rykte"; //
	$me_social_rep_points = "Sosial rykte"; //

	$Footer_About_Link = "om-oss"; //
	$Footer_Contact_Link = "kontakt"; //
	$Footer_Help_Link = "hjelp"; //
	$Footer_Developers_Link = "dev"; //
	$Footer_Privacy_Link = "personvern"; //
	$Footer_TOS_Link = "betingelser"; //
	$Footer_Badges_Link = "merker"; //

	$Common_header_title = "Elooi";
	$Common_header_home = "Hjem";
	$Common_header_profile = "Profilen";
	$Common_header_inbox = "Meldinger";
	$Common_header_more = "Mer";
	$Common_header_who_to_listen = "Lytte til?";
	$Common_header_elooi_ekle = "Legg Elooi";
	...
	$Common_header_developers = "Utviklere";
	$Common_header_latest = "Siste Elooier";

	$Common_header_Find = "Søk"; 
	...
	$Common_header_settings = "Innstillinger";
	$Common_header_help = "Hjelp";
	$Common_header_signout = "Logg ut";

	$Common_header_joinnow = "Bli medlem nå";
	$Common_header_or = "eller";
	$Common_header_login_text = "Logg på";
	$Common_header_fb_login = "Logg på med Facebook";

	$Common_header_email = "E-post";
	$Common_header_email_tip = "E-post";

	$Common_header_password = "Passord";
	$Common_header_password_tip = "Passord";

	$Common_header_home_signin_button = "Logg på";
	$Common_header_remember_me = "Husk på meg";

	$Common_header_forgot_pwd = "Glemt passordet ditt?"; //

	$Common_header_verify_email = "Vi vill at du bekrefterer e-postadressen din ved å klikke på linken vi sendte deg. (<a href=\"send-verification.php\">Send det igjen</a>)"; //
	...
	$signup_Email = "Email"; //
	$signup_Email_tip = "Plese provide an Email like dow@jones.com."; 
	...
	$GLOBALS["signup_January"] = "Januar";
	$signup_January = "Januar";
	$GLOBALS["signup_February"] = "Februar";
	$signup_February = "Februar";
	$GLOBALS["signup_March"] = "Mars";
	$signup_March = "Mars";
	$GLOBALS["signup_April"] = "April";
	$signup_April = "April";
	$GLOBALS["signup_May"] = "Mai";
	$signup_May = "Mai";
	$GLOBALS["signup_June"] = "Juni";
	$signup_June = "Juni";
	$GLOBALS["signup_July"] = "Juli";
	$signup_July = "Juli";
	$GLOBALS["signup_August"] = "August";
	$signup_August = "August";
	$GLOBALS["signup_September"] = "September";
	$signup_September = "September";
	$GLOBALS["signup_October"] = "Oktober";
	$signup_October = "Oktober";
	$GLOBALS["signup_November"] = "November";
	$signup_November = "November";
	$GLOBALS["signup_December"] = "Desember";
	$signup_December = "Desember";


	$signup_join_button = "Bli medlem nå"; //
	...
	$newelooi_Procsessing = "Behandler..."; 
	$newelooi_Procsessing_2 = "Behandler..."; 
	$newelooi_Saving = "Lagrer..."; //
	$newelooi_press_save = "Vennligst trykk Lagre på lydopptaker for å bekrefte at opptaket er gjort."; //
	$newelooi_record_upload = "Vennligst post eller laste opp dine Elooi."; //
	$newelooi_add_tags = "Vennligst skriv noen tagger til din Elooi."; //
	$newelooi_use_mic = "Jeg ønsker å bruke mikrofonen i stedet"; //
	$newelooi_use_mp3 = "Jeg har ombestemt meg la meg laste opp MP3"; //
	$newelooi_dont_forget_tags = "Dont't forget! An elooi needs <b>tags</b> to define it in the <i>Clouds</i>. You can add upto 7 tags of length 2-20 characters per elooi. You can seperate tags with space or comma."; //
	$newelooi_max_tags = "You can add a maximum of 7 tags per Elooi!"; //
	$newelooi_mp3_text = "When uploading an MP3, only the first 60 seconds will be used. For best qualtiy upload as 128kb mono."; //
	$newelooi_link_question = "Do you want to add a link to your elooi?"; //
	$newelooi_link_input = "url"; //url
	$newelooi_link_hint = "Do you want to add a link to your Elooi? <br>This is usefull if you are talking about a website a product or something that has an url.";  //
	...
	$newelooi_Language_question = "Change this elooi langauge from: ".$LanguageName.""; //
	...
	$newelooi_tags = "Tagger";  //
	$newelooi_Location = "Sted"; //
	$newelooi_add_elooi = "Legg Elooi"; //

	$newelooi_picture_question = "Klikk for å legge et bilde til Elooi din.";
	$newelooi_picture_input = "Upload Photo <span class=\"flash-buttonSmall\">(Max 5 MB)</span>";

	$generic_save_changes = "Lagre endringer"; //


	$me_add_favorite = "Favoritt";
	$me_remove_favorite = "UnFavoritt";
	$me_add_echo = "Ekko";
	$me_remove_echo = "Fjern Ekko";
	$me_reply = "Svar";
	$me_delete = "Slett";
	$me_retag = "ReTaggere";

	$me_become_listener = "Starte å lytte";
	$me_listening = "Lytter";
	$me_unbecome_listener = "Stopp Lytte";

	$me_my_timeline = "Tidslinje"; //
	$me_timeline = "Tidslinje"; //
	$me_my_mentions = "@Nevner"; //
	$me_mentions = "@Nevner"; //
	$me_my_echos = "Ekkoer"; //
	$me_echos = "Ekkoer"; //
	$me_submenu_others_echo = "Andres Ekkoer"; //
	$me_submenu_my_echos = "Mine Ekkoer"; //
	$me_submenu_my_eloois_echos = "Min Elooienes Ekkoer"; //
	$me_my_eloois = "Mine Elooier"; //
	$me_eloois = "Elooier"; //
	$me_my_favorites = "Mine Favoritter"; //
	$me_favorites = "Favoritter"; //
	$me_my_listening_to = "Lytter til"; //
	$me_listening_to = "Lytter til"; //
	$me_my_listeneres = "Mine Lyttere"; //
	$me_listeneres = "Lyttere"; //

	$me_header_tag = "tagger: "; //
	$me_header_conversation = "samtale: "; //
	$me_newest_eloois = "nye elooier"; //

	$me_no_elooi_yet = "har ikke spilt inn sin første Elooi ennå."; //
	$me_no_favorites = "har ingen favoritter ennå."; //
	$me_no_listening = "lytter ikke til noen i øyeblikket."; //
	$me_no_listeners = "har ingen lytter ennå."; //
	$me_no_others_echo = "Ingen som jeg lytter til har ekkoet en Elooi."; //
	$me_no_echo = "har ikke ekkoet en Elooi ennå."; //
	$me_user_no_echos = "har ikke hatt noen Eloois ekkoet ennå."; //
	...
	$me_elooi_seconds = "sek"; //sec
	$me_elooi_photo_link = "Bilde"; //
	$me_flagged = "Merket (<a href=\"/tos/!flaging\">Mere informasjon</a>)"; //


	$me_leftcol_user_info_listen_to = "Lytter på"; //
	$me_leftcol_user_info_listeners = "Lyttere"; //


	$me_right_col_elooi_info_flag_elooi = "Flagg Elooi"; //
	$me_right_col_elooi_info_flag_elooi_tip = "If you thik this Elooi breaks our Terms please click and we will take a look."; //
	$me_right_col_elooi_info_echos = "Ekkoer"; //
	...
	$me_right_col_elooi_info_replies = "Svar"; //
	$me_right_col_elooi_info_in_conversation = "This Elooi is part of a conversation."; //
	$me_right_col_elooi_info_trending_tags = "Trending Tagger"; //
	...
	$me_yes_button = "Ja";
	$me_apply_button = "Påfør";
	$me_cancel_button = "Avbryt";
	...
	$Elooi_Interface_Langauge_Question = "Please select the Elooi's interface langauge?";
	$Elooi_Interface_Langauge_Changed = "The Elooi Interface language has been changed to English."; 


	$Verify_Email_Error = "An error occured. Please copy&paste the link in the email we sent you. Please be sure not to including any spaces.<br><br>Thank You<br><br>"; 
	$Verify_Email_Thank_You = "Thank you your Email has been verified. You can now recive updates and notifications to your email.<br><br>"; //
	$Verify_Email_Title = "Verify Email"; //
	$Verify_Email_Return = "Click to return to Elooi."; //

	$Send_Verify_Email_Title = "Email Verification"; //

	$Send_Verify_Email_Send_Text = "Your email verification code has been re-sent to your email:<br><br><center><strong>".$_SESSION['Elooi_Email']."</center></strong><br><br>Please check your inbox as well as spam folder for instructions about how to finish verifiying your account email.<br><br>Thank You<br><br><a href=\"http://no.elooi.com\">Click to return to Elooi</a>."; 
	...
	Please check your inbox as well as spam folder for instructions about how to finish reseting your password. <br><br>
	<a href=\"http://no.elooi.com\">Click to return to Elooi</a>"; 
...
<a href=\"http://no.elooi.com\">Click to return to Elooi</a>."; 
	...
	$index_page_header = "Elooi - Skyen av Stemmer"; //
	$index_page_welcome = "Elooi - Velkommen til Skyen av Stemmer!"; //
	...
	$index_page_text = "Internett beveger seg deformere hastighet for å bli en ekte måte på kommunikasjon, selv i dag er ordet Internett blit synonymt med ordet \"Telefon\" ...
  <br><br>
  Snakker om telefon, i dag er mest av kommunikasjon på nettet gjort skriftlig. Mikroblogging nettsteder eller sosiale nettverk stafett på oss å skrive alt! Men tidene er i endring, og nå er det tiden for <strong>Elooi</strong>!
  <br><br>
  Med <strong> Elooi </strong> vil du fortelle med stemmen din ikke tastaturet!
  <br><br>
  Med <strong> Elooi </strong> vil du bli mer personlig og opplev en ny frihet!
  <br><br>
  Med <strong> Elooi </strong> vil du tale din kunnskap istedenfor og skrive!
  <br><br>
  Med <strong> Elooi </strong> vil du lytte til verden rundt deg, og snakke med alle!
  <br><br>
  Med <strong> Elooi </strong> vil du få nye venner!
  <br><br>
  Med <strong> Elooi </strong> vil du oppdage!"; //
	$index_page_mobile = "Snart vil <strong>Elooi</strong> fungere på alt mobilen!"; //
	$index_page_side_box = "<a href=\"/yeniler\">Lytt til de nyeste Elooiene</a> eller bla gjennom individuelle brukere."; //
	...
	$Settings_Account_db_Error = "An error occured, your data has not been updated."; //
	$Settings_Account_Update_Message = "<strong>Your account information has been updated.</strong>"; //
	$Settings_Account_fb_Connect = "Your <strong>facebook</strong> account has been connected to your <strong>Elooi</strong> account."; //
	...
	$tweet_message = "I've just connected Elooi to my Twitter! Come listen to me @ http://no.elooi.com/". $_SESSION['Elooi_UserName']; 
	...
	$twitter_Connect = "Connect Facebook"; //
	...
	$Settings_Account_TimeZone_Select = "Please select your timezone"; //
...
Since this is your first visit we recomend that you go over your profile as well as check out the default account, design and notification settings.<br><br>
We are very glad to have you with us.<br>"; 
  ...
  If you want to start over, just click on the Design Tab.<br><br><a href=\"#\" onClick=\"javascript:return false\">Link Color</a>";
	...
	$Settings_Notifications_New_Listener_Tip = "Everyone or just your frineds can become a listener, having a new listener is good, do you want to be informed about this?"; //
	...
	$Settings_Notifications_New_Badge_Tip = "As you Elooi more and listen more you will earn badgeds that distinguish you as a proud member of the Elooi community. Do you want to be told when you unlock a new badge?"; // 
	...
	$Settings_Notifications_News_Update_Tip = "From time to time we will introduce new feauters as well as updates. If you want to know when these things occure check here."; //
